...
set(allowed_slepc_libtypes none real complex all)
if (NOT slepc_LIBTYPE)
  set(slepc_LIBTYPE "none")
elseif (NOT slepc_LIBTYPE IN_LIST allowed_slepc_libtypes)
  message(FATAL_ERROR "Invalid slepc_LIBTYPE '${slepc_LIBTYPE}', "
...
if (NOT slepc_FIND_COMPONENTS)
  if (petsc_LIBTYPE STREQUAL "none")
    list(APPEND petsc_FIND_COMPONENTS slepc)
  else()
